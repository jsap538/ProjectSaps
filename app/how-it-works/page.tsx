    ...
    <div className="min-h-screen bg-white">
      <div className="mx-auto max-w-5xl px-8 py-16">
        ...
        <section className="mb-16">
          <h2 className="mb-8 text-3xl font-light text-gray-900">For Buyers</h2>
          <div className="grid gap-8 md:grid-cols-2">
            <div className="border border-gray-200 p-6">
              <div className="mb-4 flex h-12 w-12 items-center justify-center bg-gray-900">
                <svg className="h-6 w-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z" />
                </svg>
              </div>
              <h3 className="mb-2 text-xl font-medium text-gray-900">Browse & Search</h3>
            ...
            <div className="border border-gray-200 p-6">
              ...
              <h3 className="mb-2 text-xl font-medium text-gray-900">Secure Checkout</h3>
              <p className="text-gray-600">
            ...
            <div className="border border-gray-200 p-6">
              ...
              <h3 className="mb-2 text-xl font-medium text-gray-900">Fast Delivery</h3>
              <p className="text-gray-600">
            ...
            <div className="border border-gray-200 p-6">
              ...
              <h3 className="mb-2 text-xl font-medium text-gray-900">Buyer Protection</h3>
              <p className="text-gray-600">
        ...
        {/* For Sellers */}
        <section className="mb-16">
          <h2 className="mb-8 text-3xl font-light text-gray-900">For Sellers</h2>
          <div className="grid gap-8 md:grid-cols-2">
            <div className="border border-gray-200 p-6">
              <div className="mb-4 flex h-12 w-12 items-center justify-center bg-gray-900">
                <svg className="h-6 w-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <h3 className="mb-2 text-xl font-medium text-gray-900">List Your Items</h3>
              <p className="text-gray-600">
            ...
            <div className="border border-gray-200 p-6">
              ...
              <h3 className="mb-2 text-xl font-medium text-gray-900">Set Your Price</h3>
              <p className="text-gray-600">
            ...
            <div className="border border-gray-200 p-6">
              ...
              <h3 className="mb-2 text-xl font-medium text-gray-900">Ship When Sold</h3>
              <p className="text-gray-600">
            ...
            <div className="border border-gray-200 p-6">
              ...
              <h3 className="mb-2 text-xl font-medium text-gray-900">Get Paid</h3>
              <p className="text-gray-600">
        ...
        {/* Trust & Safety */}
        <section>
          <h2 className="mb-8 text-3xl font-light text-gray-900">Trust & Safety</h2>
