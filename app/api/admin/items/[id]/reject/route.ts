...
export async function POST(
  ...
  try {
    ...
    // Find and reject the item (mark as inactive)
    ...
    console.log(`Item ${id} rejected by admin ${userId}`);
    ...
    return NextResponse.json({ success: false, error: 'Failed to reject item' }, { status: 500, headers: corsHeaders });
  }
}
